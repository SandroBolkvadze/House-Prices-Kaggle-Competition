...
დავიწყე შედარებით მარტივი DataProcessing-ით და მოდელებით, რათა დაახლოებით გამეგო ამოცანის სირთულე. შემდეგ უკვე თანდათან ვაუმჯობესებდი DataProcessing მიდგომებსა და მოდელის არქიტექტურას.
